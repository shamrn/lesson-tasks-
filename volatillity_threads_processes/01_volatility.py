...
class Volatility:
    ...
    def open_ticker(self, file_name):
        files_ticker = os.listdir(file_name)
        for ticker_name in files_ticker:
            path_ticker = os.path.join(file_name, ticker_name)
...
trades = Volatility('trades.zip')
trades.unzip()
trades.open_ticker('trades')
trades.show()
